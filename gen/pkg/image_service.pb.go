...
var file_image_service_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0xc6, 0x01, 0x0a, 0x0c, 0x49,
	...
	0x00, 0x30, 0x01, 0x42, 0x06, 0x5a, 0x04, 0x2f, 0x70, 0x6b, 0x67, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_image_service_proto_depIdxs = []int32{
	...
	5, // 5: tgf.ImageService.SayHello:output_type -> tgf.HelloReply
	0, // 6: tgf.ImageService.LoadImage:output_type -> tgf.Empty
	1, // 7: tgf.ImageService.GetImages:output_type -> tgf.Images
	1, // 8: tgf.ImageService.GetImagesStream:output_type -> tgf.Images
